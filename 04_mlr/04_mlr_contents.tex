...
\begin{frame}{Recap: simple linear regression}
    ...
    \begin{align}
        \hat\beta_1 &= \frac{S_{xy}}{S_{xx}} = \frac{\widehat{\mathrm{Cov}}(x,y)}{s_x^2} = r\,\frac{s_y}{s_x}, \label{eq:slr-b1}\\
...
\begin{frame}{Question: combining the middle terms}
...
\begin{frame}{Check: the SLR case, ingredients}
...
\begin{frame}{Check: the SLR case, solution}
...
\begin{frame}{Fitted values and residuals}
    \begin{align}
        ...
        \hat{\mathbf y} &= \mathbf X\hat{\symbfit{\beta}} = \mathbf H\mathbf y, \notag\\
